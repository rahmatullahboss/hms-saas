      ...
      <div className="space-y-5 max-w-screen-2xl mx-auto">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { label: t('todaysIncome',   { defaultValue: "Today's Income" }),   value: fmt(dailyIncome.total),   color: 'text-emerald-600', icon: TrendingUp },
              { label: t('todaysExpenses', { defaultValue: "Today's Expenses" }), value: fmt(dailyExpenses.total), color: 'text-red-600',     icon: TrendingDown },
              { label: t('todaysProfit',   { defaultValue: "Today's Profit" }),   value: fmt(todayProfit),         color: todayProfit >= 0 ? 'text-[var(--color-primary)]' : 'text-red-600', icon: DollarSign },
              { label: t('totalStaff',     { ns: 'staff', defaultValue: 'Total Staff' }), value: staff.length, color: 'text-[var(--color-text)]', icon: Users },
