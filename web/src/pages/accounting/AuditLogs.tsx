    ...
    <DashboardLayout role={role}>
      <div className="space-y-5 max-w-screen-2xl mx-auto">
        ...
        <div className="page-header">
          <h1 className="page-title">Accounting Audit Logs</h1>
        </div>
        ...
        <div className="card p-4 flex flex-wrap gap-3">
          ...
          <button onClick={fetchLogs} className="btn-secondary text-sm">Filter</button>
        </div>
        ...
        <div className="card overflow-hidden">
          <div className="overflow-x-auto">
            <table className="table-base">
              <thead>
                <tr>
                  <th>Date</th><th>User</th><th>Action</th><th>Table</th><th>Record</th><th>Details</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={6} className="py-14 text-center text-[var(--color-text-muted)]">No audit logs found</td></tr>
                ) : (
                  logs.map(log => (
                    <tr key={log.id} className="cursor-pointer" onClick={() => setSelected(log)}>
                      ...
                      <td className="text-sm text-[var(--color-primary)] hover:underline cursor-pointer">View</td>
                    </tr>
                  ))
                )}
              </tbody>
