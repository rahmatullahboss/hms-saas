...
function getPermissions(role: string): string[] {
  const permissions: Record<string, string[]> = {
    hospital_admin: [
      ...
      'billing-master:read', 'billing-master:write',
      'provisional-billing:read', 'provisional-billing:write',
      ...
      'cancellation:read', 'cancellation:write',
      'ip-billing:read', 'ip-billing:write',
      ...
      'eprescribing:read', 'eprescribing:write',
      'medicalrecords:read', 'medicalrecords:write',
      'radiology:read', 'radiology:write',
      'lab-settings:read', 'lab-settings:write',
